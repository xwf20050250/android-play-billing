 ...
 * one item/row and so primary key is fixed, it makes sense to put the primary key here and so make
 * the class abstract.
 **/
...
/**
 * This is simple: the user either owns a premium car or s/he doesn't.
 */
@Entity(tableName = "premium_car")
data class PremiumCar(var entitled: Boolean) : Entitlement() {
